...
#Folders names that will store the uniques nfts
...
#Rarities categories and color associated 
colors = {
    'Legendary':'#ff8000',
    'Epic':'#a335ee',
    'Rare': '#0070dd',
...
#Rarities that will be stored on the json rarity displayer, this will have the same lenght as len(colors)
